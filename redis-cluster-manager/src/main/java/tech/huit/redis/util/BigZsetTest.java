...
/**
 * java -cp redis-cluster-manager-jar-with-dependencies.jar BigZsetTest count=100000 offset=0 isDel=false
...
public class BigZsetTest {
	...
	public static void main(String[] args) {
		if (args.length == 0) {
			System.out
					.println("java -cp redis-cluster-manager-jar-with-dependencies.jar BigZsetTest count=100000 offset=0 isDel=false");
			System.exit(0);
		}
